...
//make restriction to keep data only from years 2008-14

replace sample = 0 if year<2008 
...
foreach var in tlocrev tot_state_rev formal_aid other_state_rev tot_fed_rev stu_teach_ratio per_white per_black per_hisp n_tot_race per_frl per_iep per_lep BA LessHS MedianIncome Poverty Population White Black Hispanic Asian Under18 Over65 {
replace sample = 0 if `var'==.
}


sum tlocrev tot_state_rev formal_aid other_state_rev tot_fed_rev stu_teach_ratio per_white per_black per_hisp n_tot_race per_frl per_iep per_lep BA LessHS MedianIncome Poverty Population White Black Hispanic Asian Under18 Over65 if sample==1
